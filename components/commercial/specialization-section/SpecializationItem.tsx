  ...
  return (
    <Box
      ...
      className={clsx(
        ...
        index % 2 === 0 ? 'col-start-3 xs:col-start-2' : 'col-start-7 xs:col-start-8',
    ...
    >
      <div
        className="flex-center text-sm text-white bg-primary-500 group-hover:bg-secondary-500 transition-color duration-700 rounded-lg w-12 h-12 p-2"

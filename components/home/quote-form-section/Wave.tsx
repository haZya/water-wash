...
const Wave = () => {
  ...
  return (
    ...
    >
      <defs>
        <linearGradient id="gradient-top" x1="0%" y1="50%" x2="100%" y2="50%">
          <stop offset="0%" stopColor={theme.palette.primary[100]} />
          <stop offset="100%" stopColor={theme.palette.secondary[100]} />
        </linearGradient>
      </defs>
      <path

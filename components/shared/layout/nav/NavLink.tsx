  ...
  return (
    <>
      {type === 'text' ? (
        ...
        <Button
          className={clsx(
            'min-w-min shadow-md hover:shadow-md transition duration-500 border',
            color === 'primary'
            ...
            color === 'primary'
              ? activePath
                ...
                : 'bg-primary-100 hover:bg-primary-100 text-primary-900 font-semibold'
              : color === 'secondary'
              ? activePath
                ? 'bg-secondary-900 hover:bg-secondary-900 text-white font-medium'
                : 'bg-secondary-100 hover:bg-secondary-100 text-secondary-900 font-semibold'
              : activePath

...
const contacts: ILayout['navTop']['contacts'] = [
  {
    title: 'Support:',
    content: renderToStaticMarkup(<a href="tel:0422031990">0422031990</a>),
  ...
  },
  {
    ...
    content: renderToStaticMarkup(
      <a href="mailto:enquiries@waterwash.com.au">enquiries@waterwash.com.au</a>
    ),
    icon: renderToStaticMarkup(
      <svg
        version="1.0"
  ...
  useEffect(() => {
    dispatch(
      setLayout({
        layoutContent: {
          logo,
          navTop: { contacts, links: navTopLinks },
          nav: { links: navLinks },
          socials,
        },
      })
